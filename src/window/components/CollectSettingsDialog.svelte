<script lang="ts">
    ...
    const validateTime = (isoTime: string): string | undefined => {
                ...
                <div class="pl-4 pt-1" in:fade>
                    ...
                    <div id="amount" class="flex items-center gap-2 justify-between">
                        ...
                        <CollectSettingsSwitch setting={isPaid} id="collectPriceToggle">
                            <div slot="icon" class="w-full h-full">
                                <svg class="w-full h-full p-0.5 border border-black dark:border-white rounded-full"
                                     viewBox="0 0 24 24"
                        ...
                        <div class="relative rounded-lg" class:hidden={!$isPaid}>
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center">
                                ...
                                {#if !currencies}
                                    ...
                                    <svg aria-hidden="true" class="inline mr-3 w-4 h-4 text-white animate-spin"
                                         viewBox="0 0 100 101"
                                         fill="none"
                    ...
                    {#if $isPaid}
                                    ...
                                    <div slot="label">
                                        <div class="flex items-center">
                                            ...
                                            {#if splitError && $splitRevenue && !$collectSettings.recipients?.length}
                                                <svg class="w-5 h-5 text-red-600 cursor-help flex-none ml-2"
                                            ...
                                            {:else}
                                                <svg class="inline w-4 h-4 p-[0.075rem] ml-1 opacity-60 cursor-help"
                                                     viewBox="0 0 24 24" fill="none"
                                                     stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                     stroke-linejoin="round"
                                                     use:tippy={({
                                ...
                                {#if $splitRevenue}
                                    ...
                                    <div class="pl-6 flex flex-col gap-1.5" transition:slide>
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <div class="flex grow gap-3 items-center">
                                                        <img loading="lazy" decoding="async" src={avatarUrl}
                                                             ...
                                                             bg-gray-300 text-white hover:opacity-80">
                                                        ...
                                                        <div class="flex flex-col">
                                                            ...
                                                            {#if $collectSettings.price && recipient.split && $collectSettings.token}
                                                                <div class="text-xs text-gray-500 dark:text-gray-400">
                                                                    {formatCryptoValue($collectSettings.price * (recipient.split / 100))}
                                        ...
                                        <div class="flex {recipientsAtCapacity ? 'justify-end' : 'justify-between'} pb-3 pt-2 pr-8"
                                            ...
                                            <button type="button" on:click={() => addingRecipient = true}
                        ...
                        <div id="referralFee" class="flex items-center gap-4 pl-4" in:slide>
                            ...
                            <CollectSettingsSwitch setting={hasReferralFee} id="referralFeeToggle">
                                <div slot="icon" class="w-full h-full">
                                    <svg viewBox="0 0 24 24" class="w-full h-full" fill="none" stroke="currentColor"
                                         stroke-width="2"
                                         stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div class="relative rounded-lg" class:hidden={!$hasReferralFee}>
                                <input type="number" id="referralFeeInput" placeholder="5" autocomplete="off" min="0"
                                       max="100"
